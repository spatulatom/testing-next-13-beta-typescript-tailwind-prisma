...
export default async function Home() {
  await delay(6000) // 2 second delay
    ...
    return (
      ...
      <Suspense fallback={<p className='flex justify-center items-center pt-8'>Hipnotising Waves are loading...(HW are client component artificially dealyed, what we see is fallback message on Suspense)</p>}>
        <HalftoneWaves />
      </Suspense>
    </div>
    )
