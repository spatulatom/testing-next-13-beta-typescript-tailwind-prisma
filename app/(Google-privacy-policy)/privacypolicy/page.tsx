  ...
  return (
    <div className="p-6">
      ...
      <p>
        ...
        https://react-next-typescript-tailwind-prisma-postgresql.vercel.app/
      ...
      <p>
        ...
        but not limited to This application does not collect or store personal
        data.. The information that I request will be retained on your device
      ...
      <p>This policy is effective as of 2023-03-01</p>{' '}
      <p>
