...
export default async function Home() {
  ...
  try {
    ...
    if (!data || data.length === 0) {
      return (
        <div className="mb-20">
          <h1 className="mb-2 mt-1 bg-linear-to-r from-teal-600 via-black to-white bg-clip-text text-center text-xl font-bold md:text-5xl">
            Chat Room
          </h1>
    ...
    return (
      <div className="">
        ...
        <h1 className="mb-2 mt-10 bg-linear-to-r from-teal-600 via-black to-white bg-clip-text text-center text-xl font-bold">
