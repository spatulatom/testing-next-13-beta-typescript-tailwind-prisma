...
-  <a href='https://beta.nextjs.org/docs/data-fetching/mutating'>new useRouter Hook </a> imported from next/navigation (not form next/router) and a new router.refresh()  method for DATA MUTATION - solution temporarly recommended by Next.js team until a better one is found.
