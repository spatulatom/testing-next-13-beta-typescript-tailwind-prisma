...
- [What this project is actually doing](#what-this-project-is-actually-doing)
  - [1) Server-first reads on the public pages](#1-server-first-reads-on-the-public-pages)
  - [2) Client-side TanStack Query for user-specific CRUD UX](#2-client-side-tanstack-query-for-user-specific-crud-ux)
  - [3) Route handlers as the mutation boundary](#3-route-handlers-as-the-mutation-boundary)
- [Where the patterns overlap](#where-the-patterns-overlap)
- [What Next.js docs say about this split](#what-nextjs-docs-say-about-this-split)
- [What TanStack Query docs say about this split](#what-tanstack-query-docs-say-about-this-split)
- [How uncommon is this mix?](#how-uncommon-is-this-mix)
- [How this repo compares to a modern Next.js default](#how-this-repo-compares-to-a-modern-nextjs-default)
